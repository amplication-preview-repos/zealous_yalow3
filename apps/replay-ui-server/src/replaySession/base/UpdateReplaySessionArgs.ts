...
class UpdateReplaySessionArgs {
  ...
  @ApiProperty({
    required: true,
    type: () => ReplaySessionUpdateInput,
  })
  @ValidateNested()
  @Type(() => ReplaySessionUpdateInput)
  @Field(() => ReplaySessionUpdateInput, { nullable: false })
  data!: ReplaySessionUpdateInput;
}

export { UpdateReplaySessionArgs as UpdateReplaySessionArgs };
